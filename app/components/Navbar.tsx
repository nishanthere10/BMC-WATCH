...
// ── Design-system font tokens ─────────────────────────────
const FONT_HEADING = { fontFamily: "'DM Sans', 'system-ui', sans-serif" };
const FONT_BODY    = { fontFamily: "'IBM Plex Sans', 'system-ui', sans-serif" };
const FONT_MONO    = { fontFamily: "'JetBrains Mono', 'Courier New', monospace" };
    ...
    <div className="fixed top-0 w-full z-50 pointer-events-none">
      ...
      <nav className="cr-glass-subtle pointer-events-auto w-full">
        <div className="container mx-auto max-w-7xl flex h-[60px] items-center justify-between px-4 md:px-6">
          ...
          <Link href="/" className="flex items-center gap-3 group shrink-0">
            ...
            <span
              ...
              style={{ ...FONT_HEADING, letterSpacing: "-0.02em" }}
            >
              BMC<span style={{ color: "#0055A4" }} className="dark:text-[#38BDF8]">Watch</span>
            </span>
          </Link>
            ...
            {NAV_ITEMS.map((item) => {
              ...
              return (
                <Link
                  ...
                  style={{ ...FONT_BODY, fontSize: 13, fontWeight: 700 }}
                >
                  {active && (
                    <div
                      className="absolute inset-0 rounded-xl bg-[#0055A4]/8 dark:bg-[#38BDF8]/10 border-2 border-[#0055A4]/20 dark:border-[#38BDF8]/20 animate-in fade-in zoom-in-95 duration-200"
                    />
                  )}
            ...
            {loading ? (
              ...
              <div className="relative">
                <button
                  ...
                  style={{ ...FONT_BODY, fontSize: 13, fontWeight: 700 }}
                >
                  <UserCircle size={15} style={{ color: "#0055A4" }} className="dark:text-[#38BDF8]" />
                  <span>Account</span>
                  <ChevronDown
                    size={13}
                  ...
                  {profileOpen && (
                    <div
                      className="absolute right-0 top-full mt-2 w-52 bg-white dark:bg-[#0D1424] border-2 border-slate-200 dark:border-slate-700 shadow-[6px_6px_0px_0px_rgba(0,85,164,0.08)] dark:shadow-[6px_6px_0px_0px_rgba(56,189,248,0.06)] rounded-2xl overflow-hidden py-2 animate-in fade-in zoom-in-95 slide-in-from-top-2 duration-150 origin-top-right"
                    >
                      <Link
                        href="/profile"
              ...
              <Link href="/login" className="cr-btn cr-btn-primary" style={{ fontSize: 13 }}>
                <UserCircle size={14} />
                Login
              </Link>
            )}
        ...
        {/* ── Mobile Drawer ─────────────────────────────── */}
          {isOpen && (
            <div
              className="md:hidden overflow-hidden border-t-2 border-slate-100 dark:border-slate-800 animate-in slide-in-from-top-4 fade-in duration-200 origin-top"
            >
                ...
                {NAV_ITEMS.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      style={{ ...FONT_BODY, fontSize: 14, fontWeight: 700 }}
                    >
                      <item.icon size={17} />

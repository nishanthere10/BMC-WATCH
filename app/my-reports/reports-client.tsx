...
import { Award, FileText, ChevronDown, CheckCircle2, ShieldCheck, MapPin, Calendar, FileCheck, CircleDashed } from "lucide-react";
...
interface ReportsClientProps {
  reports: any[];
  profileStats: { points: number; count: number };
}

export default function MyReportsClient({ reports, profileStats }: ReportsClientProps) {
  return (
